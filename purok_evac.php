...
<head>
    ...
    <style>
        ...
        .demographic-table th:nth-child(1) {
            width: 100px;
        }
        ...
        /* Total Pop Persons */
        .demographic-table th:nth-child(4) {
            width: 90px;
        }

        /* Vulnerable Families */
        .demographic-table th:nth-child(5) {
            width: 90px;
        }

        /* Vulnerable Persons */
        .demographic-table th:nth-child(6) {
            width: 120px;
        }

        /* Plan A Center Name */
        .demographic-table th:nth-child(7) {
            width: 140px;
        }

        /* Plan A Address */
        .demographic-table th:nth-child(8) {
            width: 90px;
        }

        /* Plan A Cap Families */
        .demographic-table th:nth-child(9) {
            width: 90px;
        }

        /* Plan A Cap Persons */
        .demographic-table th:nth-child(10) {
            width: 110px;
        }

        /* To be Accom Families */
        .demographic-table th:nth-child(11) {
            width: 110px;
        }

        /* To be Accom Persons */
        .demographic-table th:nth-child(12) {
            width: 100px;
        }

        /* Not Accom Families */
        .demographic-table th:nth-child(13) {
            width: 100px;
        }

        /* Not Accom Persons */
        .demographic-table th:nth-child(14) {
            width: 120px;
        }

        /* Plan B Center Name */
        .demographic-table th:nth-child(15) {
            width: 140px;
        }

        /* Plan B Address */
        .demographic-table th:nth-child(16) {
            width: 90px;
        }

        /* Plan B Cap Families */
        .demographic-table th:nth-child(17) {
            width: 90px;
        }

        /* Plan B Cap Persons */
        .demographic-table th:nth-child(18) {
            width: 130px;
        }

        /* Not Accom AB Families */
        .demographic-table th:nth-child(19) {
            width: 130px;
        }

        /* Not Accom AB Persons */
        .demographic-table th:nth-child(20) {
            width: 120px;
        }

        /* Remarks */
        .demographic-table th:nth-child(21) {
            width: 60px;
        }
