...
<body class="bg-gray-100">
    ...
    <section class="bg-blue-600 text-white text-center py-20">
        <div class="container mx-auto">
            ...
            <button class="bg-yellow-500 text-black px-6 py-2 rounded hover:bg-yellow-400 text-decoration-none" data-bs-toggle="modal" data-bs-target="#loginModal">Get Started</button>
        </div>
    </section>
    ...
    <section id="about" class="py-16 bg-white">
        <div class="container mx-auto text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="bg-purple-50 p-6 rounded-lg shadow-md hover:scale-105 transition duration-300">
