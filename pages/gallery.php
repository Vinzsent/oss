...
<body>
    ...
    <script>
        ...
        async function fetchBarangays() {
            try {
                const response = await fetch('../actions/get_locations.php?action=barangays');
        ...
        async function fetchSitios(barangay) {
            try {
                const response = await fetch(`../actions/get_locations.php?action=sitios&barangay=${encodeURIComponent(barangay)}`);
                return await response.json();
            } catch (error) {
