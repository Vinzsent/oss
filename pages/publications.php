            ...
            <div class="col-lg-4">
                            ...
                            <select class="form-select" id="resourceSelect" name="resource" onchange="updateResource()">
                                ...
                                <?php if ($uploads_result && $uploads_result->num_rows > 0): ?>
                                    <optgroup label="Uploaded Files">
                                        ...
                                        ?>
                                                <option value="<?php echo strpos($upload['file_path'], '../') === 0 ? $upload['file_path'] : '../' . $upload['file_path']; ?>">
                ...
                <div class="stats-card">
                    ...
                    <div class="file-list">
                        ...
                        ?>
                                    <div class="file-item d-flex align-items-center cursor-pointer" onclick="selectFile('<?php echo strpos($upload['file_path'], '../') === 0 ? $upload['file_path'] : '../' . $upload['file_path']; ?>')">
...
<script>
    ...
    function uploadFile() {
        ...
        fetch('../actions/upload_handler.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
