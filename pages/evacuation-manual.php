        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="content-card">
                    ...
                    <a href="evacuation.php" class="btn btn-primary w-100 mt-2">Evacuation Map (Automatic)</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        var barangays = {
            daliao: {
                ...
                evacuationRoutes: [{
                        start: [7.008885037971703, 125.50379265512842],
                        end: [7.008885037971703, 125.50379265512842]
                    },
                    {
                        start: [7.008885037971703, 125.50379265512842],
                        end: [7.008885037971703, 125.50379265512842]
                ...
                safeZones: [{
                        coordinates: [7.009390752578677, 125.50171445559366],
                        name: 'Nakada'
                    },
                    {
                        coordinates: [7.010321221253498, 125.49893911769212],
                        name: 'Doña Rosa Phase 1'
                    },
                    {
                        coordinates: [7.015831, 125.509114],
                        name: 'Kalayaan'
                    },
                    {
                        coordinates: [7.0170, 125.5070],
                        name: 'Kalubin-an'
                    },
                    {
                        coordinates: [7.00539178227548, 125.50527172131225],
                        name: 'Kanipaan'
                    },
                    {
                        coordinates: [7.0159814747894576, 125.51423251010264],
                        name: 'Lipadas'
                    },
                    {
                        coordinates: [7.02183431495076, 125.50772897375354],
                        name: 'Mcleod'
                    },
                    {
                        coordinates: [7.008142928861825, 125.50660241698455],
                        name: 'Pantalan'
                    },
                    {
                        coordinates: [7.0146034414306, 125.50828026348327],
                        name: 'Pogi Lawis'
                    },
                    {
                        coordinates: [7.016759158375993, 125.51069182752335],
                        name: 'Prudential'
                    },
                    {
                        coordinates: [7.019465055353755, 125.50976464117946],
                        name: 'St Jude'
                    }
                ]
            },
            lizada: {
                ...
                evacuationRoutes: [{
                        start: [7.027259, 125.497706],
                        end: [7.0300, 125.5000]
                    },
                    {
                        start: [7.029175, 125.492831],
                        end: [7.033081, 125.499271]
                    }
                ],
                safeZones: [{
                        coordinates: [7.0081266390240105, 125.49165857313496],
                        name: 'Babisa'
                    },
                    {
                        coordinates: [7.006881093590256, 125.50165566391446],
                        name: 'Camarin'
                    },
                    {
                        coordinates: [7.0280, 125.4950],
                        name: 'Culosa'
                    },
                    {
                        coordinates: [7.0270, 125.4975],
                        name: 'Curvada'
                    },
                    {
                        coordinates: [6.999194364599137, 125.49794893914303],
                        name: 'Dacudao'
                    },
                    {
                        coordinates: [7.009122661145653, 125.49789303175363],
                        name: 'Doña Rosa'
                    },
                    {
                        coordinates: [7.0285, 125.4960],
                        name: 'Fisherman'
                    },
                    {
                        coordinates: [7.0295, 125.4950],
                        name: 'Glabaca'
                    },
                    {
                        coordinates: [7.0260, 125.4935],
                        name: 'Gutierez'
                    },
                    {
                        coordinates: [7.003302614623746, 125.49671567753686],
                        name: 'JV Ferriols'
                    },
                    {
                        coordinates: [7.0275, 125.4970],
                        name: 'Kasama'
                    },
                    {
                        coordinates: [7.0285, 125.4945],
                        name: 'Lawis'
                    },
                    {
                        coordinates: [7.0290, 125.4955],
                        name: 'Lizada Beach'
                    },
                    {
                        coordinates: [7.0265, 125.4960],
                        name: 'Lizada Proper'
                    },
                    {
                        coordinates: [7.0275, 125.4950],
                        name: 'Maltabis'
                    },
                    {
                        coordinates: [7.0285, 125.4965],
                        name: 'New Lizada'
                    },
                    {
                        coordinates: [7.003567897421154, 125.50239911092739],
                        name: 'Punong'
                    },
                    {
                        coordinates: [7.0280, 125.4955],
                        name: 'Riverside'
                    },
                    {
                        coordinates: [7.0270, 125.4945],
                        name: 'Samuel'
                    },
                    {
                        coordinates: [7.0265, 125.4960],
                    ...
                    {
                        coordinates: [7.003883631249645, 125.49707570645367],
                        name: 'Sodaco'
                    },
                    {
                        coordinates: [7.0285, 125.4940],
                        name: 'Sto. Niño'
                    },
                    {
                        coordinates: [6.996490874579091, 125.49305761848845],
                        name: 'Tambacan'
                    },
                    {
                        coordinates: [7.007239610358947, 125.49891460298481],
                        name: 'Villa Grande'
                    },
                    {
                        coordinates: [7.0290, 125.4945],
                        name: 'Vision'
                    }
                ]
            }
        ...
        function focusBarangay() {
            ...
            if (selectedBarangay && barangays[selectedBarangay]) {
                ...
                barangay.evacuationRoutes.forEach(route => {
                    var routeLine = L.polyline([route.start, route.end], {
                        color: 'red',
                        weight: 3,
                        dashArray: '5, 10'
                    }).addTo(map);
        ...
        function focusSitioAndRoute() {
            ...
            var sitio = barangays[selectedBarangay]?.safeZones.find(zone => zone.name === selectedSitio);
